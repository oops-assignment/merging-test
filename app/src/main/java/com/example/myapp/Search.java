...
public class Search extends AppCompatActivity implements com.example.myapp.SearchAdapter.OnButtonClickListener, com.example.myapp.SearchAdapter.OnButtonShareListenr {
    ...
    private void initSearchRecyclerView() {
        ...
        SearchAdapter = new com.example.myapp.SearchAdapter(itemsname,itemsquantity,itemstype,this,this);
        searchrecycleview.setAdapter(SearchAdapter);
    }
    @Override
    public void onButtonClick(int position) {

        Intent intent1 = new Intent(this, com.example.myapp.Update.class);
