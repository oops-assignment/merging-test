...
public class login extends AppCompatActivity {
                ...
                fAuth.signInWithEmailAndPassword(email,password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(task.isSuccessful()){
                            Toast.makeText(com.example.myapp.login.this, "logged in", Toast.LENGTH_SHORT).show();
                            startActivity(new Intent(getApplicationContext(), com.example.myapp.dashboard.class));
                            finish();
                        }else{
                            Toast.makeText(com.example.myapp.login.this, "error occured" + task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        fAuth.sendPasswordResetEmail(mail).addOnSuccessListener(new OnSuccessListener<Void>() {
                            ...
                            public void onSuccess(Void aVoid) {
                                Toast.makeText(com.example.myapp.login.this, "Reset link has been sent to your Email.", Toast.LENGTH_SHORT).show();
                            }
                        }).addOnFailureListener(new OnFailureListener() {
                            @Override
                            public void onFailure(@NonNull Exception e) {
                                Toast.makeText(com.example.myapp.login.this, "Some error occured while sending reset link" + e.getMessage(), Toast.LENGTH_SHORT).show();
                            }
                        });
    ...
    public void gotoregister(View view) {
        startActivity(new Intent(getApplicationContext(), com.example.myapp.register.class));
        finish();
    }
