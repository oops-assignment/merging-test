...
public class inventoryMain extends AppCompatActivity implements com.example.myapp.dashAdapter.OnButtonClickListener {
    ...
    private com.example.myapp.category cat1,cat2,cat3;
...
//        });
    ...
    private void setActivity() {
        Intent intent = new Intent(this, com.example.myapp.addCategory.class);
...
//        images.add("https://i.imgur.com/53QR2iB_d.webp?maxwidth=760&fidelity=grand");
    ...
    public void onButtonClick(int position) {
        Intent intent1 = new Intent(this, com.example.myapp.ItemsMain.class);
        flag = true;
