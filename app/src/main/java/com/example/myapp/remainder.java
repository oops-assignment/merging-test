...
public class remainder extends AppCompatActivity implements TimePickerDialog.OnTimeSetListener, DatePickerDialog.OnDateSetListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i=new Intent(com.example.myapp.remainder.this, com.example.myapp.ListR.class);
                startActivity(i);
            }
        });
        ...
        floatingActionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!title.isEmpty()  && !time.isEmpty() && !DString.isEmpty() ) {
                    com.example.myapp.Reminder_data data = new com.example.myapp.Reminder_data(title, cmnt, time, DString, Repeat);
                    Intent inte = new Intent(com.example.myapp.remainder.this, com.example.myapp.ListR.class);
                    startActivity(inte);
                    String id = myRef.push().getKey();
                    myRef.child(Usermailid.substring(0,2)).child("remainder").child(id).setValue(data);
                    ...
                    Toast.makeText(com.example.myapp.remainder.this, "Reminder set!", Toast.LENGTH_SHORT).show();
                }
                else {
                    Toast.makeText(com.example.myapp.remainder.this,"Enter all the details",Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        buttonTimePicker.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DialogFragment tP = new com.example.myapp.TimeSet();
        ...
        bdp.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DialogFragment datePicker=new com.example.myapp.DateSet();
...
//        });
     ...
     private void sendEmail(String ti,String cm) {
         ...
         Intent intent = new Intent(getApplicationContext(), com.example.myapp.MailReceiver.class);
     ...
     private void startRepeatingA(String t, String ch) {
         ...
         Intent intent = new Intent(getApplicationContext(), com.example.myapp.Receiver.class);
     ...
     private void cancelAlarm() {
        AlarmManager alarmManager = (AlarmManager) getSystemService(Context.ALARM_SERVICE);
        Intent intent = new Intent(this, com.example.myapp.Receiver.class);
        PendingIntent pendingIntent = PendingIntent.getBroadcast(this, 1, intent, 0);
        alarmManager.cancel(pendingIntent);
        mTextView.setText("Reminder canceled");
        mdatetext.setText("");
        mtimetext.setText("");
         Toast.makeText(com.example.myapp.remainder.this,"Cancelled",Toast.LENGTH_LONG).show();
    }
