...
public class ListTaskAdapter extends BaseAdapter {
    ...
    private com.example.myapp.DBHelper database;

    public ListTaskAdapter(Activity a, ArrayList<HashMap<String, String>> d, com.example.myapp.DBHelper mydb) {
        activity = a;
        data = d;
        database = mydb;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        com.example.myapp.ListTaskViewHolder holder = null;
        if (convertView == null) {
            holder = new com.example.myapp.ListTaskViewHolder();
            ...
            holder = (com.example.myapp.ListTaskViewHolder) convertView.getTag();
        }


        final HashMap<String, String> singleTask = data.get(position);
        final com.example.myapp.ListTaskViewHolder tmpHolder = holder;
