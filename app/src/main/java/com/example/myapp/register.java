...
public class register extends AppCompatActivity {
               ...
               fAuth.createUserWithEmailAndPassword(email,password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                   ...
                   public void onComplete(@NonNull Task<AuthResult> task) {
                       if(task.isSuccessful()) {
                           ...
                           Toast.makeText(com.example.myapp.register.this, "verification link has been sent to your mail,please verify", Toast.LENGTH_SHORT).show();
    ...
    private void requestPhoneAuth(String phoneNumber) {
                ...
                new PhoneAuthProvider.OnVerificationStateChangedCallbacks(){
                    ...
                    public void onCodeAutoRetrievalTimeOut(String s) {
                        ...
                        Toast.makeText(com.example.myapp.register.this, "OTP Timeout, Please Re-generate the OTP Again.", Toast.LENGTH_SHORT).show();
                    }
                    ...
                    public void onVerificationFailed(FirebaseException e) {
                        Toast.makeText(com.example.myapp.register.this, e.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    private void verifyAuth(PhoneAuthCredential phoneAuthCredential) {
        fAuth.signInWithCredential(credential).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if(task.isSuccessful()){
                    Toast.makeText(com.example.myapp.register.this, "phone number verified", Toast.LENGTH_SHORT).show();
                    progressBar.setVisibility(View.INVISIBLE);
                    ...
                    progressBar.setVisibility(View.INVISIBLE);
                    Toast.makeText(com.example.myapp.register.this, "Error occured", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
