...
public class to_do extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mydb = new com.example.myapp.DBHelper(this);
    ...
    public void openAddModifyTask(View view) {
        startActivity(new Intent(this, com.example.myapp.AddModifyTask.class));
    }
    ...
    public void loadListView(com.example.myapp.NoScrollListView listView, final ArrayList<HashMap<String, String>> dataList) {
        com.example.myapp.ListTaskAdapter adapter = new com.example.myapp.ListTaskAdapter(this, dataList, mydb);
        listView.setAdapter(adapter);
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View view,
                                    int position, long id) {
                Intent i = new Intent(com.example.myapp.to_do.this, com.example.myapp.AddModifyTask.class);
